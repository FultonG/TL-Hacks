...
const HealthCheck = () => {
  ...
  return (
    <Container height="90%" overflow justify="center" align="center">
      <Card width="75%" height="90%" direction="row" background="#000B1D" margin="10px" padding="40px">
        <Title>Health Check</Title>
        <Container as="form" direction="column" width="75%" height="70%" justify="space-evenly">
